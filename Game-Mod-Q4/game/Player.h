...
//	idList<rvDatabaseEntry>	database;
	...
	int						F_RANK_MARINE;
	int						S_RANK_SHOTGUN;
	int						A_RANK_HYPERBLASTER;
	int						F_RANK_GL;
	float					SHOTGUN_UPGRADE_DAMAGE;
	int						SHOTGUN_UPGRADE_FIRE_RATE;
	float					SHOTGUN_UPGRADE_SPREAD;
	int						SHOTGUN_UPGRADE_PROJ_COUNT;
	float					HYPERBLASTER_UPGRADE_DAMAGE;
	int						HYPERBLASTER_UPGRADE_FIRE_RATE;
	float					HYPERBLASTER_UPGRADE_SPREAD;
	int						HYPERBLASTER_UPGRADE_PROJ_COUNT;
	float					GL_UPGRADE_DAMAGE;
...
// squirrel: added DeadZone multiplayer
	...
	void					rewardDistributor(int numberRolled);
	int						rollForReward(void);
	void					shotgunUpgradeRoll(void);
	void					hyperblasterUpgradeRoll(void);
	void					grenadelauncherUpgradeRoll(void);
// RITUAL END
