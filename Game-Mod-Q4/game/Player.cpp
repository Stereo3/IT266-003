...
void idInventory::Clear( void ) {
	...
	F_RANK_MARINE = 0;
	S_RANK_SHOTGUN = 0;
	A_RANK_HYPERBLASTER = 0;
	F_RANK_GL = 0;
	SHOTGUN_UPGRADE_DAMAGE = 0;
	SHOTGUN_UPGRADE_FIRE_RATE = 0;
	SHOTGUN_UPGRADE_SPREAD = 0;
	SHOTGUN_UPGRADE_PROJ_COUNT = 0;
	HYPERBLASTER_UPGRADE_DAMAGE = 0;
	HYPERBLASTER_UPGRADE_FIRE_RATE = 0;
	HYPERBLASTER_UPGRADE_SPREAD = 0;
	HYPERBLASTER_UPGRADE_PROJ_COUNT = 0;
	GL_UPGRADE_DAMAGE = 0;
	GL_UPGRADE_FIRE_RATE = 0;
	GL_UPGRADE_SPREAD = 0;
	...
	if (inventory.quakePoints >= 160) {
		...
		case 0:
			if (inventory.S_RANK_MEDIC == 0) {
				...
				dict.Set("npc_name", "Steven Strange");
				inventory.S_RANK_MEDIC++;
				break;
			}
			else {
				break;
		...
		case 1:
			if (inventory.S_RANK_TECH == 0) {
				dict.Set("classname", "char_marine_tech_armed");
				dict.Set("npc_name", "John Quake");
				inventory.S_RANK_TECH++;
				break;
			}
			else {
				break;
		...
		case 2:
			if (inventory.A_RANK_GUNNER == 0) {
				dict.Set("classname", "char_marine_hyperblaster");
				dict.Set("npc_name", "Rambo");
				inventory.A_RANK_GUNNER++;
				break;
			}
			else {
				break;
		...
		case 3:
			if (inventory.B_RANK_TANK == 0) {
				dict.Set("classname", "char_marine_shotgun");
				dict.Set("npc_name", "The Murray");
				inventory.B_RANK_TANK++;
				break;
			}
			else {
				break;
		...
		case 4:
			if (inventory.F_RANK_MARINE == 0) {
				dict.Set("classname", "char_marine");
				dict.Set("npc_name", "Paul");
				inventory.F_RANK_MARINE++;
				break;
			}
			else {
				break;
